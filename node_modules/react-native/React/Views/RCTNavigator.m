                    ...
                    animated:(__unused BOOL)animated
{
  ...
  [tc animateAlongsideTransition: ^(id<UIViewControllerTransitionCoordinatorContext> context) {
    ...
    // 动画效果
//    [self transitionWithType:kCATransitionMoveIn WithSubtype:kCATransitionFromBottom ForView:self.navigationController.view];
  }
...
BOOL jsGettingtooSlow =
  ...
  if (jsGettingAhead) {
    if (reactPushOne) {
      ...
      // 动画效果
//      [self transitionWithType:kCATransitionMoveIn WithSubtype:kCATransitionFromTop ForView:self.navigationController.view];
    } else if (reactPopN) {
...
- (void) transitionWithType:(NSString *) type WithSubtype:(NSString *) subtype ForView : (UIView *) view
{
  ...
  //    tran.duration=0.5f;
  //    tran.type=@"rippleEffect";//moveIn(新视图移到旧视图上面);rippleEffect(滴水效果(不支持过渡方向))
